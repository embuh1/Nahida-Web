        ...
        <div class="pb-6">
          <div class="flex flex-wrap justify-center">
            <div class="flex justify-center w-full">
              <div class="relative">
                <img
                  src="https://media.discordapp.net/attachments/1169655452435492926/1170567283865821275/nahida-120.png?"
            ...
            <div class="w-full text-center">
              <div class="flex justify-center pt-8 pb-0 lg:pt-4">
                <div class="flex space-x-2">
                  ...
                  <a
                    class="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                    href="https://discord.gg/tjqekhnV"
                    rel="noopener"
                  ...
                  <a
                    class="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                    href="https://steamcommunity.com/id/embuh/"
                    rel="noopener"
                    aria-label="Steam"
                    target="_blank"
                    style={{ paddingRight: "18px" }}
